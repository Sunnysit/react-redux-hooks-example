...
const NameCard = () => {
  ...
  //Used to get the whole reducer object like getting characterReducer
  ...
  const toggleEditBtn = ()=>{
    ...
    return ( 
        ...
        <p>Age: {person.age}</p>
        <button onClick={toggleEditBtn} className="btn-floating halfway-fab waves-effect waves-light orange">
        {
            isEdit?
